...
## 7.7 Open WebUI không mở localhost:3000

**Fix**:
1. Docker Desktop đang chạy chưa? Mở app Docker, đợi trạng thái "running".
...
## 7.9 (Tùy chọn) Gradio 6.x đổi API gây error — chỉ khi chạy app.py
...
| | Trang chính thức |
|---|---|
| **Gradio** (tùy chọn, UI tự code) | [gradio.app](https://www.gradio.app) |
| **Streamlit** | [streamlit.io](https://streamlit.io) |
| **Chainlit** (LLM-focused) | [chainlit.io](https://chainlit.io) |
| **Open WebUI** (workshop dùng) | [openwebui.com](https://openwebui.com) · [github.com/open-webui/open-webui](https://github.com/open-webui/open-webui) |
