...
## Cấu trúc 23 slides (khớp deck render thật)
...
| 16 | Phần 2 | Demo RAG — output từ phiên test (terminal + Gradio) |
...
| 20 | Phần 3 | Demo Agent — output từ phiên test |
...
| 16 (RAG demo) | `terminal_rag_query.png` + `gradio_ui_real.png` |
