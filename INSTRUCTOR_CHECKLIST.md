...
> **Quy tắc vàng:** mọi độ trễ trên CPU là thật (RAG 15–25s, agent 15–20s). Pre-build + warm model trước thì 2h vừa khít; không thì sẽ thấy gấp.
...
## ⏱️ Bảng thời lượng (116' nội dung trong khung 2h — bảo vệ Q&A)
...
| 3. Agent (CHỈ demo) | 18' | Single-tool live, multi-tool = screenshot |
| 4. Tổng kết + Q&A | 12' | Có FAQ thủ sẵn nếu lớp im |
...
- **qwen3:1.7b chỉ gọi 1 tool/câu** — multi-tool cần 4b+. Đừng demo chain live.
